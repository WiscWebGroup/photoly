...
import {Divider, Flex, HStack, Image, Tag, TagLabel, Text, useOutsideClick, VStack} from "@chakra-ui/react";
...
const ImageView: React.FC<ImageViewProps> = ({isModalOpen, setIsModelOpen}) => {
    ...
    return (
        ...
        {isModalOpen && (
            <HStack position={"fixed"} w={"1600px"} h={"800px"} rounded={"lg"} bg={"gray.50"} top={"50%"} left={"50%"}
                    transform={"translate(-50%, -50%)"} ref={ref}>
                <Image src={"https://www.industrialempathy.com/img/remote/ZiClJf-1920w.jpg"} alt={"image"} rounded={"lg"}
