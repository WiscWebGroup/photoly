...
import {Divider, Flex, HStack, Image, Tag, TagLabel, Text, useOutsideClick, VStack***REMOVED*** from "@chakra-ui/react";
...
***REMOVED***)
    ...
    ***REMOVED***isModalOpen && (
            <HStack position={"fixed"***REMOVED*** w={"1600px"***REMOVED*** h={"800px"***REMOVED*** rounded={"lg"***REMOVED*** bg={"gray.50"***REMOVED*** top={"50%"***REMOVED*** left={"50%"***REMOVED***
                    transform={"translate(-50%, -50%)"***REMOVED*** ref={ref***REMOVED***>
                <Image src={"https://www.industrialempathy.com/img/remote/ZiClJf-1920w.jpg"***REMOVED*** alt={"image"***REMOVED*** rounded={"lg"***REMOVED***
